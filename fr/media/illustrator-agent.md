...
Une carte de réglages **Illustrator** apparaît alors, avec ses propres options. Un agent supplémentaire consomme des tokens en plus et peut déclencher des appels supplémentaires à l'IA à chaque tour. Les estimations de tokens décrivent le contexte sélectionné et les instructions des agents ; elles ne représentent pas une estimation du coût en continu.
