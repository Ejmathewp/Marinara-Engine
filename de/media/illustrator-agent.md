...
Jetzt erscheint eine **Illustrator**-Einstellungskarte mit eigenen Optionen. Ein zusätzlicher Agent verbraucht zusätzliche Tokens und kann pro Zug weitere KI-Aufrufe auslösen. Die Token-Schätzungen beschreiben den ausgewählten Kontext und die Agent-Anweisungen, nicht die laufenden Kosten.
